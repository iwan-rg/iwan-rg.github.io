...
const I18N = {
  ...
  ar: {
    ...
    "home.pubs.all": "عرض جميع المنشورات",
    ...
    "foot.built": "المنشورات محدّثة تلقائيًا من OpenAlex.",
    ...
    "pub.f.book": "كتاب / فصل",
    "pub.count": "منشور",
    "pub.loading": "جارٍ جلب أحدث المنشورات…",
    "pub.error": "تعذّر تحميل المنشورات الآن. نعرض النسخة المخزّنة، أو حاول مجددًا بعد قليل.",
    "pub.empty": "لا توجد منشورات تطابق بحثك.",
    "pub.cites": "اقتباس",
    "pub.oa": "وصول مفتوح",
    "pub.doi": "DOI",
